...
/**
 * Feature Activity that shows how to implement the TabLayout with
 * Flexible Space.
 *
...
public class TabImageActivity extends AppCompatActivity {
    ...
    public static Intent getIntent(Context context) {
        return new Intent(context, TabImageActivity.class);
    }

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tab_with_flexible_space);
